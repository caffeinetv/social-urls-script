START TRANSACTION;
UPDATE users SET social_urls = '{}' WHERE account_id IN (SELECT id FROM accounts WHERE username IN ('freerideworldtour', 'pbeffect', 'majorleaguepaintball', 'sailgp', 'grapplingnetwork', 'barstoolbaseball', 'lakersnationpodcast', 'hackcity', 'slapfight', 'dancefight', 'reflexfootball', 'omegaball', 'sportstalkchicago', 'naturalselection', 'bybextreme', 'formuladrift', 'rugbywrapup', 'apptour', 'bringthejuice', 'clutchpoints', 'mworthofgame', 'ballislife', 'barstoolsports', 'proleaguenetwork', 'fiba', 'livgolf', 'dupr', 'barstoolsportsbook', 'onewheel', 'pangea', 'officialbkb', 'funhaveroffroad', 'dnagmdw', 'mlb', 'flippertv', 'ncrugby', 'ninjasportnetwork', 'courtsidefilms', 'fighthubtv', 'ievolvetv', 'ibattletv', 'ruffinoandjoeshow', 'bleav', 'cuhmunityclips', 'coachablepodcast', 'awawiffle', 'enbl', 'pokernight', 'burton', 'caseywillax', 'purpleinsider', 'allhiphop', 'inthelab', 'karatecombat', 'a7fl', 'arsenalvision', 'gkakiteworldtour', 'mtgpofficial', 'mikethecompass', 'dewtour', 'ballersonly', 'arenawars'));
    ...
    SET social_urls = JSON_SET(
        ...
        '$."homesite"',              -- JSON key based on the simplified domain
